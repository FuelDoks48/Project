...
# 
# Цикл for для вывода имён фокусника,с каждой новой строки.
# Для каждого фокусника в списке вывести его имя. 
...
# Сортировка списка,в алфавитном порядке и изменением соритровки по-алфавиту

# cars = ["reline", "Stels", "ns bike", "darkmoor",]
# cars.sort()
# print(cars)

# ________________________________________________________________________________________________________________________________

# Сортировка списка с окончательным изменением,с обратной стороны
...
# Временная сортировка по алфавиту,без изменений в самом файле.

# cars = ["reline", "Stels", "ns bike", "darkm"]
